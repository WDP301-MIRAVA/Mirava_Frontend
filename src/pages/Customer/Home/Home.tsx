  ...
  const newsArticles = [
    {
      ...
      excerpt:
        "Khám phá những thực phẩm giúp cải thiện khả năng sinh sản tự nhiên...",
      image:
    ...
    },
    {
      ...
      excerpt:
        "Tìm hiểu về lợi ích của yoga trong việc chuẩn bị cho thai kỳ...",
      image:
    ...
    },
    {
      ...
      excerpt:
        "Vai trò quan trọng của sức khỏe tinh thần trong hành trình điều trị...",
      image:
              ...
              <div className="card-content">
                <div className="progress-container">
                  ...
                  <span className="progress-text">
                    {treatmentPlan.progress}% hoàn thành
                  </span>
                </div>
                <p className="next-step">
                  Bước tiếp theo: {treatmentPlan.nextStep}
                </p>
              </div>
            </div>
