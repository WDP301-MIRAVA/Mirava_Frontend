    ...
    <div className="payment-confirmation-container">
      <div className="left-panel">
        ...
        <div className="transfer-info">
          <p>
            <strong>Số tiền:</strong> {amount.toLocaleString("vi-VN")} đ
          </p>
          <p>
          ...
          <p>
            <strong>Chủ tài khoản:</strong> BVĐK PHUONG DONG
          </p>
        </div>
      </div>
      ...
      <div className="right-panel">
        ...
        <div className="user-info">
          ...
          <p>
            <strong>Ngày khám:</strong> {userInfo.appointmentDate}
          </p>
          <p>
            <strong>Khung giờ:</strong> {userInfo.timeSlot}
          </p>
          <p>
            <strong>Bác sĩ:</strong> {userInfo.doctor}
          </p>
          <p>
            <strong>Ghi chú:</strong> {userInfo.notes || "(Không có)"}
          </p>
        </div>
      </div>
    </div>
